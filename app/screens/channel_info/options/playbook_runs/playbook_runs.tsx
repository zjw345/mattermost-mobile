...
import {useGoToPlaybooksChannelRuns} from '@playbooks/hooks';
...
const PlaybookRuns = ({serverUrl, channelId}: Props) => {
    ...
    const goToPlaybooksChannelRuns = useGoToPlaybooksChannelRuns(channelId);

    return (
        <OptionItem
            action={preventDoubleTap(() => goToPlaybooksChannelRuns())}
            label={title}
